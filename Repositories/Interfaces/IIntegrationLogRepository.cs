...
public interface IIntegrationLogRepository
{
    ...
    IntegrationDetail AddDetail(IntegrationLog log, LogLevel status, string detailIdentifier, string? message);
    IntegrationItem AddItem(IntegrationDetail detail, string itemIdentifier, LogLevel itemStatus, string? message, object? content);
