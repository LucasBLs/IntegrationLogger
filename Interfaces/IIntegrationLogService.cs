...
public interface IIntegrationLogService
{
    ...
    IntegrationDetail AddDetail(IntegrationLog log, ActionType actionType, string? entityName, IntegrationStatus status, string detailIdentifier, string? message, string? errorMessage);
